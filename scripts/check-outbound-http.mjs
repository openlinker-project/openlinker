 ...
 * a blanket file-level suppression. InPost has no OAuth-token bypass to
 * exempt (static Bearer API token, no token endpoint).
 *
...
const SCAN_ROOTS = ['libs/integrations/prestashop', 'libs/integrations/inpost'];
