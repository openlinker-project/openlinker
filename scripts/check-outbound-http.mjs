 ...
 * a blanket file-level suppression. No such exemption is needed for DPD
 * Polska — both HTTP clients and the connection tester now route through
 * an injected `fetchImpl`, with no ad-hoc OAuth-token bypass to exempt.
 *
...
const SCAN_ROOTS = ['libs/integrations/prestashop', 'libs/integrations/dpd-polska'];
