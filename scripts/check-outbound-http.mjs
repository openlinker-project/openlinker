 ...
 * fetchSellerIdentity) — low-volume auth infra, not shop traffic. No such
 * exemption is needed for KSeF — its client has no ad-hoc OAuth-token bypass.
 *
...
const SCAN_ROOTS = ['libs/integrations/prestashop', 'libs/integrations/allegro', 'libs/integrations/ksef'];
