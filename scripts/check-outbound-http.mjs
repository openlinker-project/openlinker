 ...
 * a blanket file-level suppression. WooCommerce has no OAuth-token bypass to
 * exempt (Basic Auth via consumer key/secret, no token endpoint).
 *
...
const SCAN_ROOTS = ['libs/integrations/prestashop', 'libs/integrations/woocommerce'];
