...
![Sync Jobs list](./images/08-jobs-list.png)
...
![Job detail — metadata and payload](./images/08-job-details.png)
...
![Webhook deliveries](./images/08-webhook.png)
...
![Cursors page](./images/08-cursors.png)
