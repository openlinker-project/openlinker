...
- **A leading expander needs `vertical-align: top`.** At ~60 px a 24 px toggle centres opposite the gap between the two text lines rather than the identity it belongs to.
