...
**Four independent instances, four different scripts, four different authors, one mechanism** (#2840, 2026-09-08 — recorded because a rule with four instances behind it reads differently from one with an anecdote):
