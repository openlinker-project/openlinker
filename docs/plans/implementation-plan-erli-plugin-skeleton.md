...
- ADR-025 (`docs/architecture/adrs/025-erli-marketplace-adapter.md`) + index row in the ADR README.
...
12. **`docs/architecture/adrs/README.md`** — add ADR-025 index row.
13. **`docs/architecture-overview.md`** — add `ErliOfferManagerAdapter` / `ErliOrderSourceAdapter` to the *Future Implementations* lists under `OfferManagerPort` / `OrderSourcePort`; link ADR-025.
...
- AC (from #983): ADR-025 merged `Accepted`, linked from spec + architecture-overview, ADR index updated.
