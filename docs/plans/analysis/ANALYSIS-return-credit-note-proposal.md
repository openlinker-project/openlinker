...
| `order_changes` table + `kind` column | **ALREADY EXISTS → reuse** | `varchar(64)`, no PG enum, no CHECK (migration `1850000000006` confirms) |
...
spec above, and migration `1850000000006`.
