...
> marked `DESK` — treat it as a hypothesis to confirm, not a fact to build on. This file is updated in
...
## Session 2 — live-verified follow-up (2026-09-08)

Same store/app/API version. Token unchanged (`shpua_REDACTED`), same 16
scopes as the end of session 1. Budget started at 4000 pts, ended the session around 3980 — still no
throttling observed.
