...
4. **Migration prefix allocation.** Two children need one each. Proposed: `1842000000000` for #2599 and `1842000000001` for #2611. Whichever merges second re-prefixes to stay strictly above `main`. Someone has to own that ordering or `pnpm lint` will catch it late.
