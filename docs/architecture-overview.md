...
- **FiscalizationPort** (planned, #1908): hands a sale to a provider that performs or brokers its fiscal registration. Designed but not yet implemented - the contract, its sub-capabilities and their rationale are described once, in § Core Bounded Contexts, *15. Fiscalisation*.
