...
- **First adapter**: eparagony.pl (#1908, PL e-receipts), with status/link surfacing on the order in #1909 and the connection UI in #1911. Which document a given order gets - invoice or receipt - is the sibling routing decision (#2051), not this capability's.
