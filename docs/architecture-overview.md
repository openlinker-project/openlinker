...
> The table below is a curated highlight. The **complete, code-synced inventory of all 35 sub-capabilities across every port** (with descriptions and guards) lives in [`docs/capabilities.md`](./capabilities.md).
