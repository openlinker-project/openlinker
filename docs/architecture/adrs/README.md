...
| [ADR-040](./040-order-time-fx-stamping-connection-derived-reporting-currency.md) | Order-time FX stamping against a connection-derived reporting currency | Proposed | 2026-08-13 |
