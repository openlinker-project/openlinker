# ADR-052: Per-line tax-rate resolution, provenance and rounding ownership

- **Status**: Proposed
- **Date**: 2026-08-21
- **Authors**: @norbert-kulus-blockydevs

> **Numbering note.** #2246 named this ADR *050*. That number, and *051*, are reserved by the
> [README index](./README.md) for the #2162 async-work-layer epic (#2167, #2168); the index directs the
> next new ADR to **052**. The issue title is the stale half.
