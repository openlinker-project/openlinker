...
* **sales-documents:** POST /fiscal-registrations now answers 202 Accepted with AcceptedFiscalRegistrationResponseDto instead of 200 with FiscalRegistrationResponseDto. Callers must poll the registration-status read to learn the outcome.
* **oms:** the `locationId` propagation skip is retired ([#2324](https://github.com/openlinker-project/openlinker/issues/2324)). An inventory write naming a `locationId` now propagates to marketplaces; previously it logged `inventory_write_propagation_skipped_non_default_location` and enqueued nothing, so the channel kept whatever a pooled write last sent. No adapter in this repository is affected — WooCommerce and PrestaShop both emit `locationId: undefined`. Only an in-house or out-of-tree `InventoryMaster` adapter returning a real `locationId` changes behaviour; such connections have had their channel stock silently frozen, and their next write publishes the true aggregate, possibly as a large single-step correction in either direction. Opt out per adapter by returning `locationId: undefined`. Full procedure and the detection query: `docs/operations/inventory-location-propagation.md`.
* **web:** POST /fiscal-registrations now answers 202 Accepted with AcceptedFiscalRegistrationResponseDto instead of 200 with FiscalRegistrationResponseDto. The endpoint's own Swagger description previously told callers to read `status`/`failureMode` from the response body to learn the registration outcome - those fields no longer exist on the response. Callers must instead poll the registration-status read (GET .../registration-status) to learn the outcome.

### Features

* **analytics:** the analytics page now shows shipping-excluded GMV, a full order cohort for Units Sold/AOV/Median, a shipping-excluded net-of-VAT Cancelled Value, a trend chart that follows the selected date range, and a page-level Net/Gross VAT-basis toggle wired end to end (including the headline Revenue card and channel table units), plus a display-currency picker, a Data Coverage panel with real remediation actions, and exclusion annotations across the KPI strip and channel/product tables — verified live against real order data via two independent full accuracy re-reviews, with sections reordered to sync -&gt; needs attention -&gt; data coverage and the metrics spec updated to document the toggle ([#2452](https://github.com/openlinker-project/openlinker/issues/2452), [#2457](https://github.com/openlinker-project/openlinker/issues/2457), [#2463](https://github.com/openlinker-project/openlinker/issues/2463), [#2467](https://github.com/openlinker-project/openlinker/issues/2467), [#2479](https://github.com/openlinker-project/openlinker/issues/2479), [#2892](https://github.com/openlinker-project/openlinker/issues/2892), [#2893](https://github.com/openlinker-project/openlinker/issues/2893), [#2894](https://github.com/openlinker-project/openlinker/issues/2894), [#2895](https://github.com/openlinker-project/openlinker/issues/2895), [#2899](https://github.com/openlinker-project/openlinker/issues/2899), [#2903](https://github.com/openlinker-project/openlinker/issues/2903), [#2906](https://github.com/openlinker-project/openlinker/issues/2906), [#2907](https://github.com/openlinker-project/openlinker/issues/2907), [#2908](https://github.com/openlinker-project/openlinker/issues/2908), [#2909](https://github.com/openlinker-project/openlinker/issues/2909), [#2910](https://github.com/openlinker-project/openlinker/issues/2910)) ([#2668](https://github.com/openlinker-project/openlinker/issues/2668)) ([a707e16](https://github.com/openlinker-project/openlinker/commit/a707e1651feeda2fa28a9e9bf09e75de85df9241))
* **fulfillment:** enqueue fulfillment.work.dispatch for routed work ([#2955](https://github.com/openlinker-project/openlinker/issues/2955)) ([#2974](https://github.com/openlinker-project/openlinker/issues/2974)) ([0906ceb](https://github.com/openlinker-project/openlinker/commit/0906ceb4166be410cd4faac0508e0d3d180ac9c3))
* **fulfillment:** wire the fulfilment router through one resolver port ([#2958](https://github.com/openlinker-project/openlinker/issues/2958)) ([ad6c2d1](https://github.com/openlinker-project/openlinker/commit/ad6c2d1ec2372b7e32ecc5613d0d7811cb6a152a)), closes [#2942](https://github.com/openlinker-project/openlinker/issues/2942) [#2869](https://github.com/openlinker-project/openlinker/issues/2869)
* **oms:** sourcing-rules admin API for the router's ordered ruleset ([#2953](https://github.com/openlinker-project/openlinker/issues/2953)) ([#2973](https://github.com/openlinker-project/openlinker/issues/2973)) ([2048c2a](https://github.com/openlinker-project/openlinker/commit/2048c2aa4fbb8f235fc6f2bd47227a14a47e798c))
* **oms:** the OMS programme — Waves 0–3a ([#2675](https://github.com/openlinker-project/openlinker/issues/2675)) ([ee9fe6f](https://github.com/openlinker-project/openlinker/commit/ee9fe6fe45585bff6cae4ebb0a33b52cc23a48d2)), closes [#2282](https://github.com/openlinker-project/openlinker/issues/2282) [#2283](https://github.com/openlinker-project/openlinker/issues/2283) [#2284](https://github.com/openlinker-project/openlinker/issues/2284) [#2285](https://github.com/openlinker-project/openlinker/issues/2285) [#2286](https://github.com/openlinker-project/openlinker/issues/2286) [#2287](https://github.com/openlinker-project/openlinker/issues/2287) [#2288](https://github.com/openlinker-project/openlinker/issues/2288) [#2289](https://github.com/openlinker-project/openlinker/issues/2289) [#2298](https://github.com/openlinker-project/openlinker/issues/2298) [#2304](https://github.com/openlinker-project/openlinker/issues/2304) [#2305](https://github.com/openlinker-project/openlinker/issues/2305) [#2306](https://github.com/openlinker-project/openlinker/issues/2306) [#2307](https://github.com/openlinker-project/openlinker/issues/2307) [#2308](https://github.com/openlinker-project/openlinker/issues/2308) [#2309](https://github.com/openlinker-project/openlinker/issues/2309) [#2310](https://github.com/openlinker-project/openlinker/issues/2310) [#2311](https://github.com/openlinker-project/openlinker/issues/2311) [#2313](https://github.com/openlinker-project/openlinker/issues/2313) [#2314](https://github.com/openlinker-project/openlinker/issues/2314) [#2315](https://github.com/openlinker-project/openlinker/issues/2315) [#2316](https://github.com/openlinker-project/openlinker/issues/2316) [#2317](https://github.com/openlinker-project/openlinker/issues/2317) [#2319](https://github.com/openlinker-project/openlinker/issues/2319) [#2320](https://github.com/openlinker-project/openlinker/issues/2320) [#2321](https://github.com/openlinker-project/openlinker/issues/2321) [#2322](https://github.com/openlinker-project/openlinker/issues/2322) [#2323](https://github.com/openlinker-project/openlinker/issues/2323) [#2324](https://github.com/openlinker-project/openlinker/issues/2324) [#2327](https://github.com/openlinker-project/openlinker/issues/2327) [#2328](https://github.com/openlinker-project/openlinker/issues/2328) [#2329](https://github.com/openlinker-project/openlinker/issues/2329) [#2330](https://github.com/openlinker-project/openlinker/issues/2330) [#2332](https://github.com/openlinker-project/openlinker/issues/2332) [#2333](https://github.com/openlinker-project/openlinker/issues/2333) [#2334](https://github.com/openlinker-project/openlinker/issues/2334) [#2335](https://github.com/openlinker-project/openlinker/issues/2335) [#2336](https://github.com/openlinker-project/openlinker/issues/2336) [#2338](https://github.com/openlinker-project/openlinker/issues/2338) [#2339](https://github.com/openlinker-project/openlinker/issues/2339) [#2340](https://github.com/openlinker-project/openlinker/issues/2340) [#2341](https://github.com/openlinker-project/openlinker/issues/2341) [#2342](https://github.com/openlinker-project/openlinker/issues/2342) [#2343](https://github.com/openlinker-project/openlinker/issues/2343) [#2344](https://github.com/openlinker-project/openlinker/issues/2344) [#2345](https://github.com/openlinker-project/openlinker/issues/2345) [#2346](https://github.com/openlinker-project/openlinker/issues/2346) [#2347](https://github.com/openlinker-project/openlinker/issues/2347) [#2348](https://github.com/openlinker-project/openlinker/issues/2348) [#2349](https://github.com/openlinker-project/openlinker/issues/2349) [#2350](https://github.com/openlinker-project/openlinker/issues/2350) [#2351](https://github.com/openlinker-project/openlinker/issues/2351) [#2352](https://github.com/openlinker-project/openlinker/issues/2352) [#2353](https://github.com/openlinker-project/openlinker/issues/2353) [#2354](https://github.com/openlinker-project/openlinker/issues/2354) [#2355](https://github.com/openlinker-project/openlinker/issues/2355) [#2356](https://github.com/openlinker-project/openlinker/issues/2356) [#2357](https://github.com/openlinker-project/openlinker/issues/2357) [#2358](https://github.com/openlinker-project/openlinker/issues/2358) [#2359](https://github.com/openlinker-project/openlinker/issues/2359) [#2360](https://github.com/openlinker-project/openlinker/issues/2360) [#2361](https://github.com/openlinker-project/openlinker/issues/2361) [#2362](https://github.com/openlinker-project/openlinker/issues/2362) [#2363](https://github.com/openlinker-project/openlinker/issues/2363) [#2365](https://github.com/openlinker-project/openlinker/issues/2365) [#2366](https://github.com/openlinker-project/openlinker/issues/2366) [#2367](https://github.com/openlinker-project/openlinker/issues/2367) [#2368](https://github.com/openlinker-project/openlinker/issues/2368) [#2370](https://github.com/openlinker-project/openlinker/issues/2370) [#2371](https://github.com/openlinker-project/openlinker/issues/2371) [#2373](https://github.com/openlinker-project/openlinker/issues/2373) [#2374](https://github.com/openlinker-project/openlinker/issues/2374) [#2375](https://github.com/openlinker-project/openlinker/issues/2375) [#2376](https://github.com/openlinker-project/openlinker/issues/2376) [#2377](https://github.com/openlinker-project/openlinker/issues/2377) [#2378](https://github.com/openlinker-project/openlinker/issues/2378) [#2380](https://github.com/openlinker-project/openlinker/issues/2380) [#2381](https://github.com/openlinker-project/openlinker/issues/2381) [#2382](https://github.com/openlinker-project/openlinker/issues/2382) [#2383](https://github.com/openlinker-project/openlinker/issues/2383) [#2384](https://github.com/openlinker-project/openlinker/issues/2384) [#2388](https://github.com/openlinker-project/openlinker/issues/2388) [#2390](https://github.com/openlinker-project/openlinker/issues/2390) [#2391](https://github.com/openlinker-project/openlinker/issues/2391) [#2392](https://github.com/openlinker-project/openlinker/issues/2392) [#2393](https://github.com/openlinker-project/openlinker/issues/2393) [#2394](https://github.com/openlinker-project/openlinker/issues/2394) [#2395](https://github.com/openlinker-project/openlinker/issues/2395) [#2396](https://github.com/openlinker-project/openlinker/issues/2396) [#2397](https://github.com/openlinker-project/openlinker/issues/2397) [#2398](https://github.com/openlinker-project/openlinker/issues/2398) [#2399](https://github.com/openlinker-project/openlinker/issues/2399) [#2400](https://github.com/openlinker-project/openlinker/issues/2400) [#2401](https://github.com/openlinker-project/openlinker/issues/2401) [#2402](https://github.com/openlinker-project/openlinker/issues/2402) [#2403](https://github.com/openlinker-project/openlinker/issues/2403) [#2404](https://github.com/openlinker-project/openlinker/issues/2404) [#2405](https://github.com/openlinker-project/openlinker/issues/2405) [#2406](https://github.com/openlinker-project/openlinker/issues/2406) [#2407](https://github.com/openlinker-project/openlinker/issues/2407) [#2408](https://github.com/openlinker-project/openlinker/issues/2408) [#2409](https://github.com/openlinker-project/openlinker/issues/2409) [#2410](https://github.com/openlinker-project/openlinker/issues/2410) [#2411](https://github.com/openlinker-project/openlinker/issues/2411) [#2666](https://github.com/openlinker-project/openlinker/issues/2666) [#2673](https://github.com/openlinker-project/openlinker/issues/2673) [#2674](https://github.com/openlinker-project/openlinker/issues/2674)
* **oms:** Wave 3b — the pack bench ([#2905](https://github.com/openlinker-project/openlinker/issues/2905)) ([c1e4090](https://github.com/openlinker-project/openlinker/commit/c1e4090ee9e1123675d85a30487f3b5f4632ebd7))
* **orders:** wire buyer tax-ID onto Allegro, WooCommerce, and Erli orders ([#2824](https://github.com/openlinker-project/openlinker/issues/2824)) ([fe222ff](https://github.com/openlinker-project/openlinker/commit/fe222ffa43869e14675921cff9d83d4249775fab))
* **perf:** stand bootstrap for the measurement programme ([#2872](https://github.com/openlinker-project/openlinker/issues/2872)) ([608813d](https://github.com/openlinker-project/openlinker/commit/608813dc63b4f58d1e9a59f9d87037df9068f3e0))
* **returns:** order-detail returns panel and the return activity timeline ([#2960](https://github.com/openlinker-project/openlinker/issues/2960)) ([d5fbd36](https://github.com/openlinker-project/openlinker/commit/d5fbd3697d2d622f782d02ea758fa48b17873f47))
* **sales-documents:** routing-first market table, rebuilt order-detail panel, and e2e coverage for all three surfaces ([#2809](https://github.com/openlinker-project/openlinker/issues/2809)) ([f85e177](https://github.com/openlinker-project/openlinker/commit/f85e1775a28938b1f05a91cfff050e3c9c3dbae8)), closes [#2563](https://github.com/openlinker-project/openlinker/issues/2563) [#2806](https://github.com/openlinker-project/openlinker/issues/2806) [#2807](https://github.com/openlinker-project/openlinker/issues/2807)
* **shipping:** `shipment_lines` — line-grain shipment records ([#2727](https://github.com/openlinker-project/openlinker/issues/2727)) ([#2959](https://github.com/openlinker-project/openlinker/issues/2959)) ([e3d9604](https://github.com/openlinker-project/openlinker/commit/e3d9604edfa687ca0a84b5347777a4e07fdb51ff))
* **web:** make Analytics the landing page, rename Dashboard to Insights ([#2742](https://github.com/openlinker-project/openlinker/issues/2742)) ([5ab31e4](https://github.com/openlinker-project/openlinker/commit/5ab31e4a6d75ca0de44f3ddc9cc3d24e7e7311ee))
* **web:** order detail shows invoice and fiscal-receipt lifecycle, not just a badge ([#2763](https://github.com/openlinker-project/openlinker/issues/2763)) ([df46c64](https://github.com/openlinker-project/openlinker/commit/df46c641093ad549ac5de6c43cb0d3e8a93ebb96))
* **web:** sales-document settings page shows which markets issue documents automatically ([#2746](https://github.com/openlinker-project/openlinker/issues/2746)) ([0bce4a8](https://github.com/openlinker-project/openlinker/commit/0bce4a8fe58e0f1085d5e84ec4a6563cb59159a3))
* **web:** show each order's invoice or receipt status in the orders list ([#2761](https://github.com/openlinker-project/openlinker/issues/2761)) ([0470542](https://github.com/openlinker-project/openlinker/commit/0470542e036b130b8e85d1863f4d1ab218b251f1))


### Bug Fixes

* **ci:** close both integration-test flakes - Testcontainers network prune and the live SyncJobRunner ([#2828](https://github.com/openlinker-project/openlinker/issues/2828)) ([58d9b7e](https://github.com/openlinker-project/openlinker/commit/58d9b7ebc3b8a8946aba4a0de01319c5f1a4e453))
* **integrations-inpost:** fall back to ShipX error code as providerCode when details is empty ([#2805](https://github.com/openlinker-project/openlinker/issues/2805)) ([178538c](https://github.com/openlinker-project/openlinker/commit/178538ca304f46487b59ad78f6a2b05282f781ec))
* **integrations-prestashop:** fall back to id-ordered order feed when a shop refuses date_upd sort/filter ([#2884](https://github.com/openlinker-project/openlinker/issues/2884)) ([88425e6](https://github.com/openlinker-project/openlinker/commit/88425e6ef06f8e0fc8c22274b2233fb81355757b))
* **invoicing,fiscalization:** name the actual constraint when refusing a net-priced order ([#2837](https://github.com/openlinker-project/openlinker/issues/2837)) ([1ee9539](https://github.com/openlinker-project/openlinker/commit/1ee9539df85ed83643bd74dd26ebc75f70df637a))
* **orders:** let a PrestaShop order's total be evaluated by an orderTotalGross sales-document rule ([#2832](https://github.com/openlinker-project/openlinker/issues/2832)) ([b3db4c1](https://github.com/openlinker-project/openlinker/commit/b3db4c10e80d2ad7d70db13632c743433f227f4f))
* **sales-documents:** say delivered to, not billed to, in market copy ([#2749](https://github.com/openlinker-project/openlinker/issues/2749)) ([cf0d887](https://github.com/openlinker-project/openlinker/commit/cf0d8870cbe259f3619b65299dd239eaa415c41e)), closes [#2748](https://github.com/openlinker-project/openlinker/issues/2748)
* **web/connections:** render system-owned sync jobs as "System", not "Unknown" ([#2747](https://github.com/openlinker-project/openlinker/issues/2747)) ([7994410](https://github.com/openlinker-project/openlinker/commit/799441070241682670b095a1b0bf20d280f9c6e6))
* **web:** correct sales-document settings copy against the shipped routing evaluator ([#2756](https://github.com/openlinker-project/openlinker/issues/2756)) ([5abcc57](https://github.com/openlinker-project/openlinker/commit/5abcc57c8214a6dda1c8f811362c92e87bda75d1))
* **web:** expand Top Products detail inline instead of navigating away ([#2766](https://github.com/openlinker-project/openlinker/issues/2766)) ([a9c6a46](https://github.com/openlinker-project/openlinker/commit/a9c6a46844cb6c1f797943a7d1b063554d3baf10))
* **web:** key shipment triage on an EXACT providerCode, not merely a non-null one ([#2874](https://github.com/openlinker-project/openlinker/issues/2874)) ([1e46e8b](https://github.com/openlinker-project/openlinker/commit/1e46e8b5c23c8988b3d59b5c34a6c158e6548021))
* **woocommerce:** let a WooCommerce order's total be evaluated by an orderTotalGross sales-document rule ([#2838](https://github.com/openlinker-project/openlinker/issues/2838)) ([6adcb70](https://github.com/openlinker-project/openlinker/commit/6adcb7088b9fc3b62791cca3e45dbf93aa409205))
...
* **prestashop:** cut catalogue sync 137x (7.96 to 0.058 requests per SKU), closing [#2489](https://github.com/openlinker-project/openlinker/issues/2489) with adapter work and measurement, not a module (epic [#2590](https://github.com/openlinker-project/openlinker/issues/2590)) ([#2627](https://github.com/openlinker-project/openlinker/issues/2627)) ([e568e91](https://github.com/openlinker-project/openlinker/commit/e568e91a56017c12251bcb6206006bac01e28c44))
  * measured 7.96 to 0.058 requests per SKU on a 100,000-product catalogue (~137x reduction)
  * fan the catalogue sweep out per page ([#2593](https://github.com/openlinker-project/openlinker/issues/2593)) and batch the master stock sweep ([#2655](https://github.com/openlinker-project/openlinker/issues/2655)), instead of one request per product
  * page every list read instead of silently truncating at 100, and stop probing every product for pack availability ([#2598](https://github.com/openlinker-project/openlinker/issues/2598))
  * fix order-feed cursor loss ([#2605](https://github.com/openlinker-project/openlinker/issues/2605)), order-status mapping ([#2607](https://github.com/openlinker-project/openlinker/issues/2607)), and line pricing on cash-on-delivery orders ([#2597](https://github.com/openlinker-project/openlinker/issues/2597), [#2600](https://github.com/openlinker-project/openlinker/issues/2600))
  * harden the retry/outbox layer: split 429 from 503 and reset backoff with jitter ([#2614](https://github.com/openlinker-project/openlinker/issues/2614)), bounded outbox retention ([#2603](https://github.com/openlinker-project/openlinker/issues/2603), [#2604](https://github.com/openlinker-project/openlinker/issues/2604))
  * emit a product-deletion webhook so listings pause immediately instead of on the next sweep ([#2654](https://github.com/openlinker-project/openlinker/issues/2654))
  * add operator controls for sync pacing ([#2660](https://github.com/openlinker-project/openlinker/issues/2660)), sweep budgets ([#2659](https://github.com/openlinker-project/openlinker/issues/2659)), and per-connection backlog status
...
* **orders,analytics:** order analytics read model + sales/channel/top-products endpoints + per-line tax rate + net tax basis ([#2014](https://github.com/openlinker-project/openlinker/issues/2014)) ([fd44889](https://github.com/openlinker-project/openlinker/commit/fd4488996118b0105665f39899f88b3203bdae2f))
