 ...
 * `1842000000002` (`add-sync-job-deferred-total`) and on `origin/main`
 * `1841000000006`, so `1842000000003` is strictly greater than both.
 *
 * @module apps/api/src/migrations
 */
import type { MigrationInterface, QueryRunner } from 'typeorm';

export class AddOperationalSettings1842000000003 implements MigrationInterface {
  name = 'AddOperationalSettings1842000000003';
