...
export class AddSyncJobsTables1767551453556 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "product_variants" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "productId" uuid NOT NULL, "sku" character varying, "attributes" jsonb, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_281e3f2c55652d6a22c0aa59fd7" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_c8aa42e2481ff1992bca22a9bc" ON "inventory_items" ("productId", "productVariantId", "locationId") WHERE "productVariantId" IS NOT NULL`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_b907bd3ca244348f00e235a3f8" ON "inventory_items" ("productId", "locationId") WHERE "productVariantId" IS NULL`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_3086c88607c1c8b303fe1172f2" ON "sync_jobs" ("lockedAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_a2d0990898df9d69d7c3b53ca9" ON "sync_jobs" ("status", "nextRunAt") `);
        ...
        await queryRunner.query(`ALTER TABLE "inventory_items" ADD CONSTRAINT "FK_4a1e232a660d7d51a13f20099b2" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "inventory_items" ADD CONSTRAINT "FK_8fa4cdd8e98fde93d4f14025417" FOREIGN KEY ("productVariantId") REFERENCES "product_variants"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "inventory_items" DROP CONSTRAINT "FK_8fa4cdd8e98fde93d4f14025417"`);
