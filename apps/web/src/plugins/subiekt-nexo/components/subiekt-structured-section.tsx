...
export function SubiektStructuredSection({
  ...
  const paymentMethod = form.watch('subiektNexoPaymentMethod') ?? '';
  ...
  const effectiveLabel =
    paymentMethod === 'cash' || paymentMethod === 'transfer'
      ...
      : paymentUnsetLabel;
  const bankAccountId = form.watch('subiektNexoBankAccountId') ?? '';
  const stanowiskoKasoweId = form.watch('subiektNexoStanowiskoKasoweId') ?? '';
  ...
  function onBankAccountChange(accountId: string): void {
    syncStructuredToJson('subiektNexoBankAccountId', accountId);
    ...
    <>
      ...
      >
        <FormField
          ...
          name="subiektNexoPaymentMethod"
          error={form.formState.errors.subiektNexoPaymentMethod?.message}
          description={t(
        ...
        >
          <Select
            value={paymentMethod}
            onChange={(event) => syncStructuredToJson('subiektNexoPaymentMethod', event.target.value)}
            disabled={!configIsParseable}
            invalid={Boolean(form.formState.errors.subiektNexoPaymentMethod)}
          >
        ...
        <FormField
          ...
          name="subiektNexoStanowiskoKasoweId"
          description={t(
        ...
        >
          {cashRegistersQuery.isLoading ? (
            ...
            <Select
              ...
              onChange={(event) =>
                syncStructuredToJson('subiektNexoStanowiskoKasoweId', event.target.value)
              }
              disabled={!configIsParseable}
            >
              <option value="">
