/**
 * KsefInvoiceCorrectionFlow tests (#1233)
 *
...
function makeInvoice(overrides: Partial<InvoiceRecord> = {}): InvoiceRecord {
  return {
    ...
    status: 'issued',
    providerInvoiceId: 'ksef-101',
    providerInvoiceNumber: 'FV 101/KSeF/2026',
...
describe('KsefInvoiceCorrectionFlow', () => {
  it('renders the form header and invoice reference', async () => {
    ...
    expect(await screen.findByText(/FV 101\/KSeF\/2026/i)).toBeDefined();
  });
