...
try {
  ...
  // 4. Full invoice detail page (screen 06 parity).
  ...
  // 5. Issue a KOR correction (only if accepted).
  if (accepted) {
  ...
  // 6. Invoices list — both the original and (if issued) the correction visible.
