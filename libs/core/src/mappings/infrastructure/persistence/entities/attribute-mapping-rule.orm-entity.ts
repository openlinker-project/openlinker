 ...
 * `config` blob (discriminated by `kind`). The index name matches the migration
 * so synchronize-built schemas (integration tests) stay in parity with the
 * migration-built production schema.
 *
