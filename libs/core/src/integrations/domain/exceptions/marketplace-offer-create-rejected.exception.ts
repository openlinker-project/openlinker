/**
 * Marketplace Offer Create Rejected Exception
 *
 * Neutral domain exception thrown by any marketplace adapter implementing
 * `MarketplacePort.createOffer` when the platform rejects the create request
...
import type { CreateOfferValidationError } from '../types/marketplace-offer-create.types';

export class MarketplaceOfferCreateRejectedException extends Error {
  constructor(
    ...
    this.name = 'MarketplaceOfferCreateRejectedException';
