 ...
 *
 * @module libs/integrations/subiekt-nexo/src/__tests__
 */
...
describe('createSubiektPlugin', () => {
  describe('manifest', () => {
    ...
    it("adapterKey is 'subiekt.nexo.v1' and platformType is 'subiekt-nexo'", () => {
      expect(subiektAdapterManifest.adapterKey).toBe('subiekt.nexo.v1');
      expect(subiektAdapterManifest.platformType).toBe('subiekt-nexo');
    });
