export default {
  ...
  moduleNameMapper: {
    '^(\\.{1,2}/.*)\\.js$': '$1',
    '^@openlinker/integrations-ksef$': '<rootDir>/src/index.ts',
    '^@openlinker/integrations-ksef/(.*)$': '<rootDir>/src/$1',
    '^@openlinker/core/(.*)$': '<rootDir>/../../core/src/$1',
    '^@openlinker/shared/(.*)$': '<rootDir>/../../shared/src/$1',
    // Required: ksef-plugin.ts imports dispatchCapability and
    // ksef-integration.module.ts imports createNestAdapterModule
